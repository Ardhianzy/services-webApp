  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const rgAll = (list as ArticleDTO[])
          ...
          .map<CardLike>(a => ({
            ...
            link: a.slug ? generatePath(ROUTES.READING_GUIDE_DETAIL, { slug: a.slug }) : ROUTES.READING_GUIDE,
          }));
        ...
        <div className="mb-6 flex w-full items-center justify-between" style={{ maxWidth: headerMaxWidth }}>
          <div className="flex items-center">
            <img
              ...
              draggable={false}
            />
            <h2 id="rg_heading" className="ml-4 text-[3rem] text-white" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              Reading Guides
            </h2>
          </div>
          <a
