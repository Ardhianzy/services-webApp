...
const CommunitySection: FC = () => {
  return (
    <section
      ...
      className="relative w-screen mt-15 mb-35 overflow-visible bg-black py-24"
      style={{
      ...
      >
        ...
        <div className="stack-gap mt-38">
          ...
          >
            <h2
              id="community-title"
              className="m-0 text-center mb-3 text-[1.6rem]"
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <a
                ...
                style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.05rem", textDecoration: "none" }}
              >
                JOIN OUR DISCORD
                <img
