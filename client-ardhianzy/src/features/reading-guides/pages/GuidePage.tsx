// src/features/reading-guides/pages/GuidePage.tsx
import { useParams, useNavigate } from "react-router-dom";
import RelatedBooks from "@/features/reading-guides/components/RelatedBooks";
import * as BooksData from "@/data/books";

import type { ReadingGuide as ReadingGuideType, Author as AuthorRef, Book as BookCard } from "@/types/books";
  ...
  return !guide ? (
    ...
    <>
      <style>{`
        ...
        .gp__bebas { font-family: 'Bebas Neue', cursive !important; }
        .gp__roboto { font-family: 'Roboto', sans-serif !important; }
      `}</style>
            ...
            <main className="bg-black text-white pt-[240px] pb-[80px] min-h-screen">
              <div className="max-w-[1440px] mx-auto bg-[rgba(217,217,217,0.1)] rounded-[20px] p-10">
                <button
                  onClick={() => navigate(-1)}
                  className="
                    bg-transparent border-0 text-white cursor-pointer block
                    gp__roboto !text-[16px] !mb-5
                ...
                >
                  <aside className="flex flex-col !gap-[30px]">
                    <div className="flex !gap-5 !p-5 bg-[rgba(255,255,255,0.1)] !rounded-[20px]">
                      ...
                      <div className="author-details">
                        <h2 className="gp__bebas !text-[20px] !m-0 !mb-[10px]">{author.name}</h2>

                        {"bio" in author && author.bio ? (
                          <p className="gp__roboto !text-[16px] !leading-[1.4] text-justify !text-[#dddddd] !m-0">
                            {author.bio}
                          </p>
                        ) : null}
                      </div>
                  ...
                  <section className="bg-[rgba(114,106,106,0.15)] !rounded-[20px] !p-[25px]">
                    <h2 className="gp__bebas !text-[48px] !m-0 !pb-5 border-b border-white text-left">
                      LIST BOOKS
                    </h2>
                    ...
                    <div className="flex !gap-[15px] !p-5 !my-[30px] bg-[rgba(255,255,255,0.1)] !rounded-[20px]">
                      ...
                      <div className="warning-text">
                        <h3 className="gp__bebas !text-[20px] !m-0 !mb-[5px] text-left">WARNING:</h3>
                        <p className="gp__roboto !text-[14px] !leading-[1.3] !m-0 text-left !text-[#dddddd]">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="path-book-details">
                              <h3 className="gp__bebas !text-[40px] !leading-[1.1] !m-0 !mb-[10px]">
                                {stepBook.title}
                              </h3>
                              {stepBook.description ? (
                                <p className="gp__roboto !text-[16px] !leading-[1.4] !text-[#dddddd] !m-0">
                                  {stepBook.description}
                                </p>
                              ) : null}
                            </div>
