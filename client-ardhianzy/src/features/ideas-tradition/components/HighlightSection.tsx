  ...
  return (
    <div className="it-highlight-wrapper">
      ...
      >
        ...
        />
        <h1 className="it__bebas it__heroTitle relative z-[2] uppercase text-center text-white">
          {title}
        </h1>
      </section>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="it__roboto text-left !text-[1rem] leading-[1.6] opacity-90 max-w-[450px]">
                          {preview}
