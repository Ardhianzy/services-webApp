// src/features/ideas-tradition/pages/IdeaArticleDetailPage.tsx
...
export default function IdeaArticleDetailPage() {
  const { slug = "" } = useParams();
  const { data, loading } = useArticleDetail(slug, { category: "IDEAS_AND_TRADITIONS" });
  ...
  return (
    <main className="bg-black text-white pt-[119px] pb-[80px] min-h-screen">
      ...
      >
        <img
          src={data?.image ?? "/assets/ideas-tradition/Groupkdfk.png"}
          alt=""
