// src/features/pop-cultures/pages/PopCultureReviewDetailPage.tsx
  ...
  return (
    <>
      <style>{`
        ...
        .article-typography img, .article-typography video, .article-typography iframe {
          max-width: 100%;
          height: auto;
        }
...
export default function PopCultureReviewDetailPage() {
  const { slug = "" } = useParams();
  const { data, loading } = useArticleDetail(slug, { category: "POP_CULTURE" });
  ...
  return (
    <main className="bg-black text-white pt-[119px] pb-[80px] min-h-screen">
      ...
      >
        <img
          src={data?.image ?? "/assets/pop-culture/dadasdfe.png"}
          alt=""
